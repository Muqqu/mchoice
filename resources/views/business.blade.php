                ...
                <div class="chat-body">
                                ...
                                <div class="col-6 col-xl-6">
                                    <div class="media text-center text-xl-left">
                                        <div class="avatar avatar-sm avatar-online d-none d-lg-inline-block mr-5">
                                            <img src="{{ empty($business->profile) ? asset('storage/index.jpg') : asset(\Storage::url($business->profile)) }}"
                                ...
                                <div class="message">
                                    ...
                                    <a class="avatar avatar-sm mr-4 mr-lg-5" href="#"
                                        ...
                                        <img class="avatar-img"
                                            src="{{ empty($business->profile) ? asset('storage/index.jpg') : asset(\Storage::url($business->profile)) }}"
                                            alt="">
                                    </a>
                    ...
                    <div class="chat-footer border-top py-4 py-lg-6 px-lg-8">
                        <div class="container-xxl">
                            ...
                            <form id="chat-id-2-form" action="{{ route('post_create', $page->id) }}" data-emoji-form=""
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button
                                                        ...
                                                        <img src="{{ asset('assets/images/smile.svg') }}"
                                                            data-inject-svg="" alt="">
                                                    </button>
                                                </div>
                                                ...
                                                <div class="input-group-append">
                                                    <button id="chat-upload-btn-2"
                                                        ...
                                                        type="button">
                                                        <img src="{{ asset('assets/images/paperclip.svg') }}"
                                                            data-inject-svg="" alt="">
                                                    </button>
                                                </div>
