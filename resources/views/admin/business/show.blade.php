                            ...
                            <div class="row">
                                <div class="col s12 m7">
                                    <div class="display-flex media">
                                        <a href="#" class="avatar">
                                            <img src="{{ empty($businesses->profile) ? asset('storage/index.jpg') : asset(\Storage::url($businesses->profile)) }}"
                                                alt="users view avatar" class="z-depth-4 circle" height="64"
                                                width="64"></td>
                                        </a>
                                        <div class="media-body">
                                            <h6 class="media-heading">
                                                <span class="users-view">{{ $businesses->name }}</span>

                                            </h6>
                                            <span>ID:</span>
                                            <span class="users-view">{{ $businesses->id }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div
                            ...
                            <div class="card-content">
                                <div class="row indigo lighten-5 border-radius-4 mb-2">
                                    <div class="col s12 m4 users-view-timeline">
                                        <h6 class="indigo-text m-0">Product:
                                            <span>{{ $businesses->products->count() }}</span></h6>
                                    </div>
                                            ...
                                            @if (!empty($businesses->products))
                                                @foreach ($businesses->products as $product)
                                                    <tr>
                                                        <td>Photo:</td>
                                                        <td class="users-view">
                                                            <img src="{{ empty($product->img) ? asset('storage/index.jpg') : asset(\Storage::url($product->img)) }}"
