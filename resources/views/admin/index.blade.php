                            ...
                            <div class="row">
                                ...
                                @foreach ($count as $k => $c)
                                    <div class="col s12 m6 l6 xl3">
                                        <div
                                            class="card gradient-45deg-{{ $color[$i] }} gradient-shadow min-height-100 white-text animate {{ $k % 2 ? 'fadeLeft' : 'fadeRight' }}">
                                            <div class="padding-4">
                                                <div class="row">
                                                    <div class="col s7 m7">
                                                        <i
                                                            class="material-icons background-round mt-5 {{ $c->icon }}"></i>
