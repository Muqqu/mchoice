                    ...
                    <div class="row">
                        <div class="col s10 m6 l6">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.group.index') }}">Groups</a>
                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12" id="account">
                                        ...
                                        <div class="media display-flex align-items-center mb-2">
                                            <a class="mr-2" href="#">
                                                <img src="{{ empty($group->profile) ? asset('storage/index.jpg') : asset(\Storage::url($group->profile)) }}"
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="user-edit-btns display-flex">
                                                    <form
                                                        action="{{ route('admin.group.profile.update', $group->id) }}"
                                                    ...
                                                    @if (!empty($group->profile))
                                                        <form
                                                            action="{{ route('admin.group.profile.delete', $group->id) }}"
                                                            method="post">
                                                            @method('delete')
                                                            @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 input-field">
                                                            <input id="name" name="name" type="text"
                                                                class="validate" value="{{ $group->name }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 input-field">
                                                            <input id="description" name="description" type="text"
                                                                class="validate" value="{{ $group->description }}"
                                                                    ...
                                                                    <td>
                                                                        <label>
                                                                            <input type="checkbox" name="members[]"
                                                                                ...
                                                                                {{ $member->id == $group->user_id ? 'disabled' : '' }}>
                                                                            <span></span>
                                                                        </label>
                                                                    </td>
                                                                </tr>
