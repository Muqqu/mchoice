                            ...
                            <div class="card-content">
                                <div class="row indigo lighten-5 border-radius-4 mb-2">
                                    <div class="col s12 m4 users-view-timeline">
                                        <h6 class="indigo-text m-0">GroupMember: <span>{{ $group->members->count() }}</span>
                                        </h6>
                                    </div>
                                    <div class="col s12 m4 users-view-timeline">
                                                ...
                                                @foreach ($members as $member)
                                                    <tr>
                                                        ...
                                                        <td class="users-view">
                                                            ...
                                                            <img src="{{ empty($member->profile) ? asset('storage/index.jpg') : asset(\Storage::url($member->profile)) }}"
