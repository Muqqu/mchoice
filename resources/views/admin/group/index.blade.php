                                            ...
                                            <tbody>
                                                @foreach ($groups as $group)
                                                    <tr>
                                                        ...
                                                        <!--<td>Staff</td>-->
                                                        <td><a href="{{ route('admin.group.edit', $group->id) }}"><i
                                                                    class="material-icons">edit</i></a></td>
                                                        <td><a href="{{ route('admin.group.show', $group->id) }}"><i
                                                                    class="material-icons">remove_red_eye</i></a></td>
                                                        <td>
                                                            <a href="#"
                                                                onClick="$('#delete_{{ $group->id }}').submit()">
                                                                <i class="material-icons fa fa-trash"></i>
                                                            </a>
                                                            <form id="delete_{{ $group->id }}" method="post"
                                                                action="{{ route('admin.group.destroy', $group->id) }}">
                                                                @method('delete')
                                                                @csrf
                                                            </form>
                                                        </td>
