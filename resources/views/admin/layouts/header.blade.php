                        <div class="header-top">
                            <div class="logo ml-2 mt-3">
                                <a href="{{ route('home') }}">
                                    <img src="{{ asset('/template/assets/img/logo.png') }}" alt="Agwis Messanger"
                                        class="header_image">
                                </a>
                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right header_drop_icon">
                                        ...
                                        <a class="dropdown-item" data-toggle="modal"
                                            data-target="#profile_modal">Profile</a>
                                        <a class="dropdown-item" data-toggle="modal"
                        ...
                        <ul class="nav nav-tabs chat-tabs mt-4">
                            <li class="nav-item">
                                <a class="nav-link {{ $currentRoute == 'home' ? 'active' : '' }}"
                                    href="{{ route('home') }}">Chats</a>
                            </li>
                            <li class="nav-item ml-1">
                                <a class="nav-link {{ $currentRoute == 'page' ? 'active' : '' }}"
                                    href="{{ route('page') }}">Pages</a>
                            </li>
                            <li class="nav-item ml-1">
                                <a class="nav-link {{ $currentRoute == 'status' ? 'active' : '' }}"
                                    href="{{ route('status') }}">Status</a>
                            </li>
                            <li class="nav-item ml-1">
                                <a class="nav-link {{ $currentRoute == 'call' ? 'active' : '' }}"
                                    href="{{ route('call') }}">Call</a>
                            </li>
                        </ul>
