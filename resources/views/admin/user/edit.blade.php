    ...
    <div id="main">
        <div class="row">
            ...
            <div class="col s12">
                                ...
                                <div class="row">
                                    <div class="col s12" id="account">
                                        ...
                                        <div class="media display-flex align-items-center mb-2">
                                            <a class="mr-2" href="#">
                                                <img src="{{ empty($user->profile) ? asset('storage/index.jpg') : asset(\Storage::url($user->profile)) }}"
                                                    alt="users view avatar" class="z-depth-4 circle" " alt="users avatar" class="z-depth-4 circle"
                    height="64" width="64">
                </a>
              ...
              <form id="accountForm" method="post" action="{{ route('admin.user.update', $user->id) }}">
                @csrf
                <div class="row">
                  <div class="col s12 m6">
                    <div class="row">
                      ...
                      <div class="col s12 input-field">
                        <input id="mobile" name="mobile" type="text" class="validate" value="{{ $user->mobile }}"
