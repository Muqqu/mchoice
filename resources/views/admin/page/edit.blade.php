...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="{{ asset('theme/app-assets/images/favicon/favicon-32x32.png') }}">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">

    <!-- BEGIN: VENDOR CSS-->
    <link rel="stylesheet" href="{{ asset('theme/app-assets/vendors/vendors.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('theme/app-assets/vendors/select2/select2.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('theme/app-assets/vendors/select2/select2-materialize.css') }}"
        type="text/css">
    <!-- END: VENDOR CSS-->

    <!-- BEGIN: Page Level CSS-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('theme/app-assets/css/themes/vertical-modern-menu-templ/materialize.min.6.delay') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('theme/app-assets/css/themes/vertical-modern-menu-template/style.min.css') }}">
...
<body
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Page #{{ $page->id }} Edit</span></h5>
                            <ol class="breadcrumbs mb-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('admin.page.index') }}">Pages</a>
                                </li>
                                <li class="breadcrumb-item active">Page Edit
                                </li>
                            </ol>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12" id="account">
                                        ...
                                        <div class="media display-flex align-items-center mb-2">
                                            <a class="mr-2" href="#">
                                                <img src="{{ empty($page->profile) ? asset('storage/index.jpg') : asset(\Storage::url($page->profile)) }}"
                                                    alt="" class="z-depth-4 circle" height="64"
                                                    width="64">
                                            </a>
                                            <div class="media-body">
                                                <h5 class="media-heading mt-0">{{ ucwords($page->name) }}</h5>
                                                <div class="user-edit-btns display-flex">
                                                    <form action="{{ route('admin.page.profile.update', $page->id) }}"
                                                        ...
                                                        <button class="btn-small indigo">Change</button>
                                                    </form>
                                                    @if (!empty($page->profile))
                                                        <form
                                                            action="{{ route('admin.page.profile.delete', $page->id) }}"
                                                            method="post">
                                                            @method('delete')
                                                            @csrf
                                                            <button class="btn-small btn-light-pink">Remove</button>
                                                        </form>
                                                    @endif
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 input-field">
                                                            <input id="name" name="name" type="text"
                                                                class="validate" value="{{ $page->name }}"
                                                        ...
                                                        <div class="col s12 input-field">
                                                            <input id="uname" name="uname" type="text"
                                                                class="validate" value="{{ $page->uname }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 input-field">
                                                            <input id="description" name="description" type="text"
                                                                class="validate" value="{{ $page->description }}"
                                                                    ...
                                                                    <td>
                                                                        <label>
                                                                            <input type="checkbox" name="followers[]"
                                                                                value="{{ $follower->id }}" checked
                                                                                {{ $follower->id == $page->user_id ? 'disabled' : '' }}>
                                                                            <span></span>
                                                                        </label>
                                                                    </td>
                                                                </tr>
                                ...
                                <div class="slide-out-right-body row pl-3">
                                    <div id="messages" class="col s12 pb-0">
                                        <div class="collection border-none mb-0">
                                            <input class="header-search-input mt-4 mb-2" type="text"
                                                name="Search" placeholder="Search Messages" />
    ...
    <script src="{{ asset('theme/app-assets/vendors/select2/select2.full.min.js') }}"></script>
    <script src="{{ asset('theme/app-assets/vendors/jquery-validation/jquery.validate.min.js') }}"></script>
    <!-- END PAGE VENDOR JS-->
