                            ...
                            <div class="accordion modified-accordion mb-n6 mb-lg-8" id="profile-settings">
                                <div class="card-columns">
                                        ...
                                        <div id="profile-settings-account" class="collapse" data-parent="#profile-settings">
                                            <div class="card-body">
                                                ...
                                                <form action="{{ route('profile') }}" method="post" id="profile-form"
                                                    ...
                                                    @csrf
                                                    <div class="form-group">
                                                        <x-auth-validation-errors class="text-center mb-6"
                                                            :errors="$errors" />
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control form-control-lg" id="name"
                                                            type="text" placeholder="Type your name" name="name"
                                                            value="{{ $user->name }}">
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="small" for="profile-phone">Phone</label>
                                                        <input class="form-control form-control-lg" id="mobile"
                                                            type="text" placeholder="(123) 456-7890" name="mobile"
                                                            value="{{ $user->mobile }}">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control form-control-lg" id="email"
                                                            type="email" placeholder="you@yoursite.com" name="email"
                                                            value="{{ $user->email }}">
                                                    </div>

                                                    <!-- <div class="form-group">
                                                      <label class="small" for="profile-about">Bio</label>
                                                      <textarea class="form-control form-control-lg" id="profile-about" rows="3" placeholder="Express yourself"
                                                          data-autosize="true" name="bio"></textarea>
                                                  </div>-->
                                        ...
                                        <div id="profile-settings-security" class="collapse"
                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('password') }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="small" for="current-password">Current
                                                            password</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="small" for="verify-password">Verify
                                                            password</label>
                                                        <input name="verify-password" id="verify-password"
                                                            type="password" class="form-control form-control-lg"
                                    ...
                                    <div class="card mb-6 mb-lg-8">
                                        ...
                                        <div id="profile-settings-social" class="collapse"
                                            data-parent="#profile-settings">
                                            <div class="card-body">
                                                ...
                                                <form action="{{ route('social') }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="profile-twitter" type="text"
                                                                class="form-control form-control-lg"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="profile-facebook" type="text"
                                                                class="form-control form-control-lg"
                                                                placeholder="Username" aria-label="Username">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="profile-instagram" type="text"
                                                                class="form-control form-control-lg"
                                                                placeholder="Username" aria-label="Username">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="profile-github" type="text"
                                                                class="form-control form-control-lg"
                                                                placeholder="Username" aria-label="Username">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="profile-slack" type="text"
                                                                class="form-control form-control-lg"
                                                                placeholder="Username" aria-label="Username">
                                                        </div>
                                                    </div>
