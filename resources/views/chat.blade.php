                                ...
                                <div class="col-6 col-xl-6">
                                    <div class="media text-center text-xl-left">
                                        <div class="avatar avatar-sm avatar-online d-none d-lg-inline-block mr-5">
                                            <img src="{{ empty($sender->profile) ? asset('storage/index.jpg') : asset(\Storage::url($sender->profile)) }}"
                                    ...
                                    <div class="message">
                                        ...
                                        <a class="avatar avatar-sm mr-4 mr-lg-5" href="#"
                                            ...
                                            <img class="avatar-img"
                                                src="{{ empty($sender->profile) ? asset('storage/index.jpg') : asset(\Storage::url($sender->profile)) }}"
                                                alt="">
                                        </a>
                        ...
                        <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="border-bottom text-center py-9 px-10">
                                ...
                                <div class="avatar avatar-xl mx-5 mb-5">
                                    <img class="avatar-img" src="{{ asset($sender->profile) }}"
                                        alt="{{ $sender->name }}">
                                </div>
                                <h5>{{ $sender->name }}</h5>
                                            ...
                                            <li class="list-group-item py-6">
                                                <div class="media align-items-center">
                                                    <div class="media-body">
                                                        ...
                                                        <p><a href='{{ $business->website }}'
                                                                target='blank'>{{ $business->website }}</a></p>
                                                    </div>
                                                    ...
                                                    <li class="list-group-item py-6">
                                                        <div class="media">
                                                            ...
                                                            <div class="icon-shape bg-primary text-white mr-5">
                                                                ...
                                                                @else
                                                                    <img src="{{ asset(\Storage::url($product->img)) }}"
                                                            ...
                                                            <div class="media-body align-self-center overflow-hidden">
                                                                <h6 class="text-truncate mb-0">
                                                                    <a href="#" class="text-reset"
                                                                        title="E5419783-047D-4B4C-B30E-F24DD8247731.JPG">{{ $product->name }}</a>
                                                                </h6>
