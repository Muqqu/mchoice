                ...
                <div class="chat-body">
                                    ...
                                    <div class="message">
                                        ...
                                        <a class="avatar avatar-sm mr-4 mr-lg-5" href="#"
                                            ...
                                            <img class="avatar-img"
                                                src="{{ empty($chat->users->profile) ? asset('storage/index.jpg') : asset(\Storage::url($chat->users->profile)) }}"
                                                alt="">
                                        </a>
                                            ...
                                            <div class="message-row">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="message-content bg-light">
                                                        ...
                                                        <div class="mt-1">
                                                            <small
                                                                class="opacity-65">{{ date('H:i a', strtotime($chat->created_at)) }}</small>
                                                        </div>
                                                    </div>
                                                    <!-- Message: content -->
                                                    ...
                                                    <!-- Message: dropdown -->
                                                    <div class="dropdown">
                                                        <a class="text-muted opacity-60 ml-3" href="#"
                    ...
                    <div class="chat-footer border-top py-4 py-lg-6 px-lg-8">
                        <div class="container-xxl">
                            ...
                            <form id="chat-id-2-form" action="{{ route('groupchat', $group->id) }}" data-emoji-form=""
                                method="post">
                                @csrf
                                <div class="form-row align-items-center">
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <!-- Textarea -->
                                            <textarea id="chat-id-2-input" name="msg" class="form-control bg-transparent border-0"
                        ...
                        <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="border-bottom text-center py-9 px-10">
                                ...
                                <div class="avatar avatar-xl mx-5 mb-5">
                                    <img class="avatar-img"
                                        src="{{ empty($group->profile) ? asset('storage/index.jpg') : asset(\Storage::url($group->profile)) }}"
                            ...
                            <ul class="nav nav-tabs nav-justified bg-light rounded-0" role="tablist">
                                <li class="nav-item">
                                    <a href="#chat-id-1-members" class="nav-link active" data-toggle="tab"
                                        role="tab" aria-selected="true">Members</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#chat-id-1-files" class="nav-link" data-toggle="tab"
                                        role="tab">Files</a>
                                </li>
                            </ul>
                            <!-- Navs -->
                                                ...
                                                <li class="list-group-item py-6">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="avatar avatar-sm avatar-online mr-5">
                                                            <img class="avatar-img"
                                                                src="{{ empty($member->profile) ? asset('storage/index.jpg') : asset(\Storage::url($member->profile)) }}"
                                                                alt="{{ ucwords($member->name) }}">
                                                        </div>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item d-flex align-items-center"
                                                                        href="#">
                                                                        Promote <span
                                                                            class="ml-auto fe-trending-up"></span>
                                                                    </a>
                                                                    <a class="dropdown-item d-flex align-items-center"
                                                                        href="#">
                                                                        Restrict <span
                                                                            class="ml-auto fe-trending-down"></span>
                                                                    </a>
                                                                    <a class="dropdown-item d-flex align-items-center"
                                                                        href="#">
                                                    ...
                                                    <div class="align-self-center ml-auto">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <input class="custom-control-input"
                                                                id="id-add-user-chat-1-user-{{ $member->id }}"
                                                                type="checkbox" value="{{ $member->id }}"
                                                                name="members[]" {{ $checked }}>
                                                            <label class="custom-control-label"
                                                                for="id-add-user-chat-1-user-{{ $member->id }}"></label>
                                                        </div>
                                                    </div>
                    ...
                    <div class="d-flex h-100 flex-column">
                        ...
                        <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="border-bottom text-center py-9 px-10">
                                ...
                                <p class="text-muted">Bootstrap is an open source toolkit for developing web with HTML,
                                    CSS, and JS.</p>
                            </div>
